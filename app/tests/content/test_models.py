...
def test_poll_model():
    poll = Poll(title="Опрос", description="Пусто", start="2021-01-12 00:00", finish="2021-01-15 00:00")
...
def test_question_model():
    poll = Poll(title="Опрос", description="Пусто", start="2021-01-12 00:00", finish="2021-01-15 00:00")
    question = Question(text="Вопрос", type_q="Ответ с выбором одного варианта", poll=poll)
